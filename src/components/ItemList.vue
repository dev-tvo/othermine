<template>
  <div class="items">
    <Item v-for="item in items" :key="item.id" :id="item.id" :name="item.name" :itemType="item.itemType"
          :rarity="item.rarity" :craftingCost="item.craftingCost"
          :curseType="item.curseType" :shopCost="item.shopCost" :minorCurseCost="item.minorCurseCost"
          :majorCurseCost="item.majorCurseCost" :effect="item.effect"
